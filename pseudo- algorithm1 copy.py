...
def Cities_in_California():
    ...
    open file.txt as file:
        ...
        for line in file_lines:
            ...
            <loop through values and remove characters: '[]' and seperate with a space>
        ...
        sorted_dict = <sort dictionary by items in my_dict >
        ...
        # sort dictionary, by looking at the key & returning the corresponding value for each pair to the sorted function
        sorted_dict2 = <sort dictionary by items in my_dict2 >
